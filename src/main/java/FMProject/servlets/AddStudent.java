...
public class AddStudent extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FMProject.beans.StudentBean bean=new FMProject.beans.StudentBean(name, email, sex, course, fee, paid, due, address, contact);
		int status=FMProject.dao.StudentDao.save(bean);
